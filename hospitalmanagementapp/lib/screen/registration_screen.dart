...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  // Function to simulate a registration process (replace this with your actual registration logic)
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            // Use a FutureBuilder to handle the registration process
            FutureBuilder(
              future: performRegistration(),

...
class NurseManagePatient extends StatefulWidget {
  const NurseManagePatient({super.key});

  @override
  State<NurseManagePatient> createState() => _NurseManagePatientState();
}

class _NurseManagePatientState extends State<NurseManagePatient> {
